  ...
  "language_models": {
    "openai_compatible": {
      "社内 Foundry": {
        ...
        "available_models": [
          {
            "name": "gpt5codex-apac",      // deployment 名。既定・主力(gpt-5.3-codex)。APAC 処理
...
|---|---|---|
| コーディング（既定） | `gpt5codex-apac` | [prompts/coding-agent.md](../prompts/coding-agent.md) の本文 |
| ログ解析 | `gpt5codex-apac` | [prompts/log-analysis.md](../prompts/log-analysis.md) の本文 |
...
| モデルが見つからない | deployment 名の typo | `gpt5codex-apac`（P2で `deepseek-apac`）を確認 |
